...
<body>
    <main>
        <div class="index-container">
            <div>
                <h1>Money Control</h1>
                <p>The system that help you to control your money!</p>
            </div>
            <div>
        ...
        <footer>
            <div class="footer-container">
                <a href="">Copyright © 2025 <a href="https://github.com/lucasFreitasDev97">Lucas Freitas</a>. All rights reserved.</a>
            </div>
        </footer>
    </main>
</body>
